...
$sql = "SELECT products.*, category AS category
        FROM products 
...
<div class="content">
    <h2>Daftar Produk</h2>
    <a href="create-produk.php" class="add-button">Create Produk</a>
    <table>
        <tr>
            <th>ID</th>
            <th>Nama Produk</th>
        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>   <?php 
    // Menentukan path barcode
    $barcodeFile = 'uploads/' . $row['barcode'] . '.png'; 
    ?>
    <img src="<?= $barcodeFile ?>" alt="Barcode" width="70"></td>
                    <td><?= $row['qty'] ?></td>
                    ...
                    <td>
                        <a href="edit-produk.php?id=<?= $row['id'] ?>">Edit</i></a> | 
                        <a href="delete-produk.php?id=<?= $row['id'] ?>" onclick="return confirm('Hapus Produk ini?')">Hapus</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        <?php else: ?>
            <tr>
                <td colspan="11" class="empty-message">Tidak ada data produk.</td>
            </tr>
        <?php endif; ?>
    </table>
</div>
